...
<body>
    ...
    <section id="context">
        <div class="container">
            ...
            <div class="content">
                <p>La migración en las Américas es un fenómeno complejo influenciado por disparidades económicas, inestabilidad política y factores ambientales. [Inserte datos verificados y fuentes aquí, como estadísticas de la Organización Internacional para las Migraciones (OIM) o informes de las Naciones Unidas sobre tendencias migratorias en la región.] Este contexto resalta la necesidad de respuestas humanitarias coordinadas para asegurar la protección y la dignidad de los migrantes.</p>
            </div>
        </div>
    </section>
    ...
    <footer>
        <p>Creado por Haití – MKMUN 2025</p>
    </footer>
